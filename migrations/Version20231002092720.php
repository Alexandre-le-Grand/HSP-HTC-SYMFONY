 ...
 */
final class Version20231002092720 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE administrateur DROP FOREIGN KEY FK_32EB52E8E23C4497');
        $this->addSql('DROP INDEX IDX_32EB52E8E23C4497 ON administrateur');
        $this->addSql('ALTER TABLE administrateur DROP ref_admin_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE administrateur ADD ref_admin_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE administrateur ADD CONSTRAINT FK_32EB52E8E23C4497 FOREIGN KEY (ref_admin_id) REFERENCES administrateur (id)');
        $this->addSql('CREATE INDEX IDX_32EB52E8E23C4497 ON administrateur (ref_admin_id)');
